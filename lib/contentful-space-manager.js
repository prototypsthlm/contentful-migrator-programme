...
export default async function spaceModule  (spaceId, envId, accessToken) {
    const client = createClient({accessToken})//contentful.createClient({ accessToken })
